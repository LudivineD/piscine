    ...
    <body id="page">
        ...
        <div id="category">
                    ...
                    <div class="data">
                        <p>
                            <?php
                                ...
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(1)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 1,1"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 1,1";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(2)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 2,2"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 2,2";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(3)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 3,3"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 3,3";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(4)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 4,4"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 4,4";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(5)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 5,5"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 5,5";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(6)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 6,6"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 6,6";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(7)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 7,7"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 7,7";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(8)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 8,8"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 8,8";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(9)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 9,9"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 9,9";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(10)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 10,10"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 10,10";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(11)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <a href="javascript:visibilite('aff1');"><img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=livre.Id LIMIT 11,11"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg"></a>
                    </div>
                    <div class="data">
                        <p>
                            <?php
                                ...
                                $db_found = mysqli_select_db($db_handle, $database);
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, livre WHERE item.Id=livre.Id LIMIT 11,11";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
                                    $result = mysqli_query($db_handle, $sql);

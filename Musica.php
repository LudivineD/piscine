...
<html class="no-js" lang="en">
    ...
    <body id="page">
        ...
        <div id="category">
                    ...
                    <div class="data">
                        <p>
                            <?php
                                ...
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, sport WHERE item.Id=musique.Id LIMIT 3,3";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(112)">
                    </div>
                </div>
                <div class="element">
                    <div class="sous-element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(109)">
                    </div>
                </div>
                <div class="element">
                    <div class="sous-element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(110)">
                    </div>
                </div>
                <div class="element">
                    <div class="sous-element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(111)">
                    </div>
                </div>
            </div>
        </div>

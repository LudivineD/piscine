...
<html class="no-js" lang="en">
    ...
    <body id="page">
        ...
        <div id="category">
                    ...
                    <div class="data">
                        <p>
                            <?php
                                ...
                                if ($db_found) {
                                    $sql = "SELECT item.Nom FROM item, sport WHERE item.Id=sport.Id LIMIT 3,3";
                                    if ($q != "") {
                                        $sql .= " AND Nom LIKE '%$q%'";
                                    }
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(203)">
			</form> 
                    </div>
                </div>
                <div class="element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(204)">
                ...
                <div class="element">
                    <div class="sous-element">
                        <img src="<?php $q = isset($_GET["q"])? $_GET["q"] : ""; $database = "amazon"; $db_handle = mysqli_connect('localhost', 'root', ''); $db_found = mysqli_select_db($db_handle, $database); if ($db_found) { $sql = "SELECT item.Photo FROM item, livre WHERE item.Id=sport.Id LIMIT 3,3"; if ($q != "") { $sql .= " AND Nom LIKE '%$q%'"; } $result = mysqli_query($db_handle, $sql); $data = mysqli_fetch_assoc($result); echo $data['Photo']; } mysqli_close($db_handle); ?>" width="za158.jpg" height="188.jpg">                    </div>
                    <div class="data">
                        <p>
                            <?php
                                $q = isset($_GET["q"])? $_GET["q"] : "";
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(206)">
			</form> 
                    </div>
                </div>
                <div class="element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(207)">
                    </div>
                </div>
                <div class="element">
                    <div class="sous-element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(208)">
                    </div>
                </div>
                <div class="element">
                    <div class="sous-element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(209)">
                    </div>
                </div>
                <div class="element">
                    <div class="sous-element">
			...
			<input type="button" name="button1" value= "Ajouter"style=" margin-left:20px;", onclick="getproductData(210)">
                    </div>
                </div>
